...
\item Produced graph was too large - the graph created using this method contained up to 2.5 milion nodes. This resulted in overall graph sizes of over 150 MB, which is extremely large for a mobile application.
