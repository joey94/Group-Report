...
\begin{document}
    \section{Accessing Android Sensors}
        ...
        \subsection{Acceleration Class Implementation}
            ...
            unnecessary values, as discussed prior. Following this, the reading delay is set to a value of ten, thus ten sensor readings are taken per second. More than this value
