...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{MVCLayout.png}
\label{MVC}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{NavigationController.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{InitialStoryboard.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{IOSRoomSearchInStoryboard.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{IOSRoomSearchInApp.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{IOSAlertSheet.png}
\label{IOSAlertSheet}
